    ...
    <div class="max-w-[1400px] mx-auto flex flex-col lg:flex-row gap-8">
        ...
        <div class="lg:w-1/5 hidden lg:block">
            <div class="bg-white rounded-lg shadow-sm p-6 sticky top-24">
                ...
                <div class="mt-8 pt-6 border-t border-gray-100">
                    ...
                    <p class="text-brand-blue font-bold text-sm">admissions@pcis.edu.ph</p>
                </div>
            </div>
        </div>
        ...
        <div class="lg:w-4/5">
           ...
           <!-- SUCCESS MESSAGE -->
            @if(session('success'))
                <div class="bg-white rounded-xl shadow-soft p-12 text-center h-full flex flex-col items-center justify-center min-h-[500px]">
                    ...
                    <div class="flex gap-4">
                        ...
                        <a href="{{ route('apply.form') }}" class="px-8 py-3 bg-brand-blue text-white font-bold rounded-lg hover:bg-blue-800 transition">
                            Submit Another
                        </a>
                    </div>
                </div>
            ...
            @else
                <!-- THE FORM (Shows if NO success message) -->
                <form action="{{ route('apply.submit') }}" method="POST" novalidate class="bg-white rounded-xl shadow-sm p-8 md:p-12 relative min-h-[600px]">
                    @csrf
